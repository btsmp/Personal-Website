    ...
    >
      <Fade>
        <ul className="flex items-center justify-center text-center w-full">
          ...
          <li className='hover:bg-white w-full h-full py-2 hover:text-[#0A0A0A] duration-300 cursor-pointer'><a href="#techs">Techs</a></li>
          <li className='hover:bg-white w-full h-full py-2 hover:text-[#0A0A0A] duration-300 cursor-pointer'><a href="#projects">Projetos</a></li>
        </ul>
      </Fade>
    </header>
  )
