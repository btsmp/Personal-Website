    ...
    <Fade triggerOnce direction='right'>
      ...
      <div className='text-center p-7 '>
        <ul className='flex justify-between items-center  '>
          <li><a href="https://www.linkedin.com/in/brunosmp/" target='_blank' rel="noreferrer"><AiOutlineLinkedin size={30} opacity={0.9} /></a></li>
          <li><a href="https://github.com/btsmp" target='_blank' rel="noreferrer"><AiFillGithub size={30} opacity={0.9} /></a></li>
          <li><a href="https://wa.me/5582993191313" target='_blank' rel="noreferrer"><AiOutlineWhatsApp size={30} opacity={0.9} /></a></li>
        </ul>
        <a
